...
chcp 65001 >nul
cd /d "%~dp0"
echo === nesy.app.getmuscle GitHub 푸시 ===
echo.
...
git remote add origin https://github.com/orukim-develop/nesy.app.getmuscle.git
git push -u origin main
echo.
echo === 완료. 위에 에러 없으면 https://github.com/orukim-develop/nesy.app.getmuscle 에서 확인 ===
pause
